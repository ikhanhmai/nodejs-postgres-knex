    ...
    bcrypt.hash(req.body.password1, salt, (err, hash) => {
      ...
      database('users')
        ...
        .then(user => {
          ...
          let link = process.env.BASE_URL + user[0].token;
        ...
        database
          ...
          .then(result => {
            if (result.length) {
              ...
              let link = process.env.BASE_URL + result[0].token;
      ...
      if (emailData.length == 0) {
        ...
        database
          ...
          .then(done => {
            ...
            let content = '<body><p>Please reset your password.</p> <a href=' + link + '>Reset Password</a></body>';
